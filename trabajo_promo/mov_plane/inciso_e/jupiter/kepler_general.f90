...
program kepler
  ...
  t_0 = 0._pr ; m_1 = 317.9_pr*(3.0016_pr*real(1E-6,pr)) ; m_2 = 1._pr
  periodo = 4332.59_pr ; h = real(1E-1,pr)
  npasos = int(periodo/h)
  !
  ! Defino las condiciones iniciales. Cabe aclarar que x(1) = x , x(2) = dx/dt = vx , x(3) = y , x(4) = dy/dt = vy
  x(1) = 4.950429_pr ; x(2) = 0._pr
  x(3) = 0._pr ; x(4) = 0.007924_pr !0.005408587_pr = velocida calculada con shooting, la que se usa es de tabla
  !
  ...
  afelio = 5.458104_pr ; perihelio = 4.950429_pr
