...
program kepler
  ...
  t_0 = 0._pr ; m_1 = 0.056_pr*(3.0016_pr*real(1E-6,pr)) ; m_2 = 1._pr
  periodo = 87.969 ; h = real(1E-1,pr)
  npasos = int(periodo/h)
  !
  ! Defino las condiciones iniciales. Cabe aclarar que x(1) = x , x(2) = dx/dt = vx , x(3) = y , x(4) = dy/dt = vy
  x(1) = 0.307499_pr ; x(2) = 0._pr
  x(3) = 0._pr ; x(4) = 0.034064_pr !0.0182586391626_pr = calculada con disparo que no dan las cosas
  !
  ...
  afelio = 0.466697_pr ; perihelio = 0.307499_pr
