! ============================================================================================= !
!   Modulo que contiene la subrutina que calcula K1, K2, K3 y K4 de Runge-Kutta de orden 4      !
!   y da la salida x(t+h). Todo se hace de forma vectorial como esta definido RK4 para n        !
!   dimensiones en el Kincaid - Sexta Edicion.                                                  !
!                                                                                               !
!   Las entradas de la subrutina son: * la dimension del sistema de ODE's, * las condiciones    !
!                                      iniciales, * el tiempo, * el paso h, * la subrutina      !
!                                      que contiene las funciones F tales que dx/dt = F         !
!                                                                                               !
!   La salida de la subrutina es x(t+h).                                                        !
! ============================================================================================= !
module runge_kutta4
!
contains
